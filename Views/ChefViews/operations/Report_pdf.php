<?php
   ...
   require_once __DIR__ . '/../../operations/PDF_Export_Action.php';
   require_once __DIR__ . '/../../operations/PDF_Export_Action_multi.php';
    ...
    //hadchi ta3 data d rapport : 
      ...
      switch ($type) {
        case 1:
            ...
            exportTableToPDF($data,'Rapport_unites_enseignement_'.$department['acronym'].'.pdf','Unités d\'Enseignement De Département ' . $department['departement_name']);   
            break;
        case 2:
            ...
            exportTableToPDF($data,'Rapport_enseignant_'.$department['acronym'].'.pdf','Enseignants De Département '.$department['departement_name'], $highlightedRows);   
            break;
        default :
            ...
            $data = [
                [
                    'title' => 'Enseignants De Département '.$department['departement_name'],
                    'data' => $Sheet1
                ],
                [
                    'title' => 'Unités d\'Enseignement De Département ' . $department['departement_name'],
                    'data' => $Sheet2
                ]
            ];
